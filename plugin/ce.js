...
cobra.addCommand({pattern: 'archive', fromMe: true, desc: ARC, dontAddCommandList: true}, (async (message, match) => {
...
cobra.addCommand({pattern: 'unarchive', fromMe: true, desc: ARC, dontAddCommandList: true}, (async (message, match) => {
