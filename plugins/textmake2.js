...
cobra.addCommand({pattern: 'birthday ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { caption: Config.CAPTION_MSG, thumbnail: Buffer.from(buffer_data.data)})
}));
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/wabotcobra/lmsg.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/wabotcobra/lmsg.jpg'), MessageType.image, { caption: Config.CAPTION_MSG, thumbnail: fs.readFileSync('/root/wabotcobra/lmsg.jpg') })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/wabotcobra/horror.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/wabotcobra/horror.jpg'), MessageType.image, { caption: Config.CAPTION_MSG, thumbnail: fs.readFileSync('/root/wabotcobra/horror.jpg') })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/wabotcobra/thusk.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/wabotcobra/thusk.jpg'), MessageType.image, { caption: Config.CAPTION_MSG, thumbnail: fs.readFileSync('/root/wabotcobra/thusk.jpg') })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/wabotcobra/clod.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/wabotcobra/clod.jpg'), MessageType.image, { caption: Config.CAPTION_MSG, thumbnail: fs.readFileSync('/root/wabotcobra/clod.jpg') })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/wabotcobra/blkpk.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/wabotcobra/blkpk.jpg'), MessageType.image, { caption: Config.CAPTION_MSG, thumbnail: fs.readFileSync('/root/wabotcobra/blkpk.jpg') })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/wabotcobra/drpwter.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/wabotcobra/drpwter.jpg'), MessageType.image, { caption: Config.CAPTION_MSG, thumbnail: fs.readFileSync('/root/wabotcobra/drpwter.jpg') })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/wabotcobra/rcld.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/wabotcobra/rcld.jpg'), MessageType.image, { caption: Config.CAPTION_MSG, thumbnail: fs.readFileSync('/root/wabotcobra/rcld.jpg') })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/wabotcobra/grved.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/wabotcobra/grved.jpg'), MessageType.image, { caption: Config.CAPTION_MSG, thumbnail: fs.readFileSync('/root/wabotcobra/grved.jpg') })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/wabotcobra/smsand.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/wabotcobra/smsand.jpg'), MessageType.image, { caption: Config.CAPTION_MSG, thumbnail: fs.readFileSync('/root/wabotcobra/smsand.jpg') })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/wabotcobra/beak.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/wabotcobra/beak.jpg'), MessageType.image, { caption: Config.CAPTION_MSG, thumbnail: fs.readFileSync('/root/wabotcobra/beak.jpg') })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/wabotcobra/1917.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/wabotcobra/1917.jpg'), MessageType.image, { caption: Config.CAPTION_MSG, thumbnail: fs.readFileSync('/root/wabotcobra/1917.jpg') })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/wabotcobra/blood.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/wabotcobra/blood.jpg'), MessageType.image, { caption: Config.CAPTION_MSG, thumbnail: fs.readFileSync('/root/wabotcobra/blood.jpg') })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/wabotcobra/fwndo.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/wabotcobra/fwndo.jpg'), MessageType.image, { caption: Config.CAPTION_MSG, thumbnail: fs.readFileSync('/root/wabotcobra/fwndo.jpg') })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/wabotcobra/fspk.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/wabotcobra/fspk.jpg'), MessageType.image, { caption: Config.CAPTION_MSG, thumbnail: fs.readFileSync('/root/wabotcobra/fspk.jpg') })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/wabotcobra/2blood.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/wabotcobra/2blood.jpg'), MessageType.image, { caption: Config.CAPTION_MSG, thumbnail: fs.readFileSync('/root/wabotcobra/2blood.jpg') })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/wabotcobra/xposure.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/wabotcobra/xposure.jpg'), MessageType.image, { caption: Config.CAPTION_MSG, thumbnail: fs.readFileSync('/root/wabotcobra/xposure.jpg') })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/wabotcobra/mggma.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/wabotcobra/mggma.jpg'), MessageType.image, { caption: Config.CAPTION_MSG, thumbnail: fs.readFileSync('/root/wabotcobra/mggma.jpg') })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/wabotcobra/shdw.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/wabotcobra/shdw.jpg'), MessageType.image, { caption: Config.CAPTION_MSG, thumbnail: fs.readFileSync('/root/wabotcobra/shdw.jpg') })
              })
          } catch(err) { 
              console.log(err)
          } 
